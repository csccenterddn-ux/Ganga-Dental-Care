...
export default function Chatbot() {
  ...
  const promptText = viewedTreatment
    ...
    : "Hi Ganga Dental Care, I'd like to get some guidance on treatments.";

  const floatText = viewedTreatment
    ? `Hi, I'm interested in ${viewedTreatment}. I'd like to learn more and book an appointment.`
    : "Hi Ganga Dental Care, I'd like to book an appointment.";
  ...
  return (
    <div className="fixed bottom-[84px] sm:bottom-[30px] right-[20px] sm:right-[30px] z-50 pointer-events-none">
      <AnimatePresence>
        {showPrompt && (
          ...
          >
            ...
            <a
              href={`https://wa.me/918218630020?text=${encodeURIComponent(promptText)}`}
              target="_blank"
      ...
      <motion.a
        href={`https://wa.me/918218630020?text=${encodeURIComponent(floatText)}`}
        target="_blank"
        rel="noopener noreferrer"
        animate={{ 
          scale: [1, 1.05, 1],
